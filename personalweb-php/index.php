...
<?php foreach($previewVer as $prev):?>
    <div class="group box-content w-4/5 h-auto bg-gray-300 m-auto cursor-pointer rounded-lg transform md:hover:-translate-y-3 hover:shadow-lg md:hover:shadow-2xl md:transition md:duration-400 py-4 md:py-8 p-2 md:p-4">
        <a href="<?= $prev['href'];?>">
